...
from .utils import load_data, compute_metrics, save_metrics
...
def train_and_evaluate(target: str = 'mood'):
    ...
    model_path = os.path.join(base_dir, 'dnn_baseline.h5')
    model.save(model_path)
    model.save_weights(os.path.join(base_dir, 'dnn_baseline.weights.h5'))
    return metrics
